...
call build.cmd -arch x64 -os windows -s clr.aot+libs -c Debug > C:\Work\Core\LakshanF\CSharp\src\aot\experiments\Diagnostics\Logging\PortEventPipe\build3\build_2.log
...
call build.cmd -subset clr+libs -configuration Release -runtimeConfiguration Debug > C:\Work\Core\LakshanF\CSharp\src\aot\experiments\Diagnostics\Logging\PortEventPipe\build3\build_10.log
call src\tests\build.cmd nativeaot Debug tree nativeaot > C:\Work\Core\LakshanF\CSharp\src\aot\experiments\Diagnostics\Logging\PortEventPipe\build3\build_11.log
call src\tests\run.cmd runnativeaottests Debug > C:\Work\Core\LakshanF\CSharp\src\aot\experiments\Diagnostics\Logging\PortEventPipe\build3\build_12.log
call src\tests\build.cmd nativeaot Debug x64 tree nativeaot /p:BuildNativeAotFrameworkObjects=true -bl > C:\Work\Core\LakshanF\CSharp\src\aot\experiments\Diagnostics\Logging\PortEventPipe\build3\build_13.log


call build.cmd -arch x64 -os windows -s clr.aot+host.native+libs -rc Release -lc Release -hc Release > C:\Work\Core\LakshanF\CSharp\src\aot\experiments\Diagnostics\Logging\PortEventPipe\build3\build_20.log
...
call src\tests\build.cmd nativeaot Debug tree tracing > C:\Work\Core\LakshanF\CSharp\src\aot\experiments\Diagnostics\Logging\PortEventPipe\build3\build_30.log
call build.cmd -s clr.aot+host.native+libs+libs.tests -c Release /p:TestNativeAot=true /p:UseNativeAotCoreLib=true > C:\Work\Core\LakshanF\CSharp\src\aot\experiments\Diagnostics\Logging\PortEventPipe\build3\build_50.log
